...
RSpec.describe Cart do
  describe 'Instance Methods' do
    ...
    it '.grand_total' do
      ...
      expect(cart2.grand_total).to eq(181.25)
    end
    ...
    it '.discount_price()' do
      ...
      expect(cart2.discount_price(pen.id)).to eq(0.75)
      expect(cart2.discount_price(tire.id)).to eq(0)
      expect(cart2.discount_price(paper_clip.id)).to eq(0)
      expect(cart2.discount_price(tack.id)).to eq(1.50)
    end
    ...
    it '.applicable_discount()' do
      ...
      expect(cart2.applicable_discount(pen.id)).to eq(discount1)
      expect(cart2.applicable_discount(tire.id)).to eq(nil)
      expect(cart2.applicable_discount(paper_clip.id)).to eq(nil)
      expect(cart2.applicable_discount(tack.id)).to eq(discount2)
    end
  end
end
